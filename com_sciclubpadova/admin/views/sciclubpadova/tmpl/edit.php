...
<form action="<?php echo JRoute::_('index.php?option=com_sciclubpadova&layout=edit&id=' . (int) $this->item->id); ?>"
  ...
  <input id="jform_title" type="hidden" name="sciclubpadova-message-title"/>

    <div class="form-horizontal">

      <?php echo JHtml::_('bootstrap.startTabSet', 'myTab', array('active' => 'details')); ?>
      <?php echo JHtml::_('bootstrap.addTab', 'myTab', 'details',
          empty($this->item->id) ? JText::_('COM_SCICLUBPADOVA_TAB_NEW_MESSAGE') : JText::_('COM_SCICLUBPADOVA_TAB_EDIT_MESSAGE')); ?>
          <fieldset class="adminform">
              <legend><?php echo JText::_('COM_SCICLUBPADOVA_LEGEND_DETAILS') ?></legend>
              <div class="row-fluid">
                  <div class="span6">
      ...
      <?php echo JHtml::_('bootstrap.addTab', 'myTab', 'params', JText::_('COM_SCICLUBPADOVA_TAB_PARAMS')); ?>
          <fieldset class="adminform">
              <legend><?php echo JText::_('COM_SCICLUBPADOVA_LEGEND_PARAMS') ?></legend>
              <div class="row-fluid">
                  <div class="span6">
      ...
      <?php echo JHtml::_('bootstrap.addTab', 'myTab', 'permissions', JText::_('COM_SCICLUBPADOVA_TAB_PERMISSIONS')); ?>
          <fieldset class="adminform">
              <legend><?php echo JText::_('COM_SCICLUBPADOVA_LEGEND_PERMISSIONS') ?></legend>
              <div class="row-fluid">
                  <div class="span12">
